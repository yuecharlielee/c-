...
int main()
{
    ...
    while (true)
    {
        ...
        if (operate == 1)
        {
            if ((queue_tail_pointer + 1) % 5 == queue_head_pointer%5)
            {
            ...
            {
                cin >> new_num;
                queuea[queue_tail_pointer%5] = new_num;
                queue_tail_pointer++;
                cout << "Queue contents are:";
                for (int i = queue_head_pointer; i < queue_tail_pointer; i++)
                {
        ...
        {
            if (queue_head_pointer%5 == queue_tail_pointer%5)
            {
            ...
            {
                cout << "Get value: " << queuea[queue_head_pointer%5] << "\n";
                queue_head_pointer++;
                cout << "Queue contents are:";
                for (int i = queue_head_pointer; i < queue_tail_pointer; i++)
                {
